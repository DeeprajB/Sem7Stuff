...
# Form implementation generated from reading ui file 'Exp3.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.output.clicked.connect(self.convert_to_negative)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Negative of an Image"))
        self.import_image.setText(_translate("MainWindow", "Import"))
        self.output.setText(_translate("MainWindow", "Convert to Negative"))
    ...
    def convert_to_negative(self):
        ...
        for i in range(0,row-1):
            for j in range(0,col-1):
                ...
                self.img[i, j] = pixel
        cv2.imwrite('negative_output.jpg',self.img)
        self.imageoutput.setPixmap(QtGui.QPixmap("negative_output.jpg"))
